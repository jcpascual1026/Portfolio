...
const yOff = 0.005;
const zOff = 0.0005;
const backgroundColor = 'hsla(240,50%,3%,1)';
...
function updateParticle(i) {
  ...
  x = particleProps[i];
  y = particleProps[i2];
  theta = angle(x, y, mouse.x, mouse.y) + 0.75 * HALF_PI;
  let force = 3;
  vx = lerp(particleProps[i3], force * cos(theta), 0.08);
  vy = lerp(particleProps[i4], force * sin(theta), 0.08);
